			...
			<?php foreach ( $faq_cats as $index => $category ) : ?>
				<div class="fade-in-down"
					...
					<div id="<?php echo "faq-cat-" . $category->term_id ?>"
						 class="faq-handler | rounded-full cursor-pointer duration-300 text-black bg-white text-center p-2 border hover:bg-black  hover:border-primary-0 hover:text-white transition-all ">
