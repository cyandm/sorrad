<?php
 function show_product_in_right($title,$subtitlee,$more,$product_one_id,$product_two_id){
...
<section class="mb-20 max-w-full overflow-x-hidden my-7">
    <div class="container mx-auto">
        <div class="flex flex-col lg:flex-row flex-wrap items-center">
            ...
            ?>
            <div class="w-full lg:w-[25%] flex shadow-cxl lg:shadow-none rounded-2xl gap-5 items-center justify-end mb-2 p-5 lg:p-0 order-2 lg:order-1">
                ...
                <a href="<?= esc_url($product_link);?>" class="w-[30%] lg:w-full relative">
                    <?php 
                    if ($product_image) {
                        echo '<img class="w-full relative lg:right-[-40px]" src="' . esc_url($product_image[0]) . '" alt="' . esc_attr($product_name) . '">';
                    }
                    ?>
                </a>
            </div>
            ...
            ?>
                ...
                <div class="w-full lg:w-[25%] flex shadow-cxl lg:shadow-none rounded-2xl gap-5 items-center justify-end mb-2 p-5 lg:p-0 order-3 lg:order-2">
                    <div class="block lg:hidden text-ctext text-left relative w-[70%] ">
                        <h3 class="text-xs text-normal"><?= esc_html($product_english_name);?></h3>
                        <h2 class="mt-1 mb-2"><a href="<?= esc_url($product_link);?>" class="text-ctext"><?= esc_html($product_name);?></a></h2>
                        <span  class="text-xs">تومان</span>
            ...
            <?php } ?>
            <div class="w-full lg:w-[50%] px-0 lg:px-10 lg:pr-20 lg:pl-10 order-1 lg:order-3">
            ...
            <a href="<?= esc_url($more);?>" class="block lg:hidden  order-3 lg:order-2 mt-4 mb-6 text-center lg:text-right order-4">مشاهده عطرها<i class="mr-2"></i></a>
        </div>
    </div>
</section>
<?php
